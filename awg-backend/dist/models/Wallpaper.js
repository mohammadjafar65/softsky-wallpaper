...
const wallpaperSchema = new mongoose_1.Schema({
    ...
    packId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Pack' },
...
exports.default = mongoose_1.default.model('Wallpaper', wallpaperSchema);

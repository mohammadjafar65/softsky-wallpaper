...
export default function Subscriptions() {
  ...
  return (
    <AdminPage
      ...
      actions={
        <Button kind="secondary" renderIcon={Renew} disabled={isRefreshing} onClick={() => void loadSubscriptionData(true)}>
    ...
    >
              ...
              {sortedBreakdown.map(([plan, count]) => {
                ...
                return (
                  <div key={plan} className="admin-callout">
                    ...
                    <div className="admin-progress-track" aria-label={`${plan} plan share`}>
                      <div className="admin-progress-bar" style={{ width: `${percentage}%` }} />
                    </div>
                    <p className="admin-authors">{percentage}% of current users</p>
                  </div>
                );
              })}
            </div>
                      ...
                      <tr key={user.id}>
                        ...
                        <td>
                          <Button
                            ...
                            size="sm"
                            renderIcon={Edit}
                            iconDescription="Edit subscription"
                            hasIconOnly
                            onClick={() => {
      ...
      <EditUserModal
        ...
        onSuccess={() => {
          ...
          void loadSubscriptionData(true);
        }}
      />
    </AdminPage>
  );
